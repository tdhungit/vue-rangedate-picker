...
const presetRangeLabel = {
    ...
    VN: {
        ...
        thisMonth: 'Tháng này',
        lastMonth: 'Tháng sau',
        //lastSevenDays: 'Sau 7 ngày',
        lastThirtyDays: 'Sau 30 ngày',
        lastNDays: 'Sau N ngày'
    }
}
...
const defaultPresets = function (i18n = defaultI18n) {
    return {
        ...
        lastNDays: function () {
            ...
            return {
                name: 'lastNDays',
                label: presetRangeLabel[i18n].lastNDays,
                active: false,
                dateRange: {
                    start: start,
                    end: end
...
export default {
    ...
    methods: {
        ...
        updatePreset(item) {
            ...
            if (this.presetActive == presetRangeLabel[this.i18n].lastNDays) {
                this.changeNDays()
            } else {
        ...
        changeNDays: function () {

            const n = new Date()
            const days = parseInt(this.ndays) - 1;
            const start = new Date(n.getFullYear(), n.getMonth(), n.getDate() - days)
            const end = new Date(n.getFullYear(), n.getMonth(), n.getDate() + 1)

            this.presetActive = presetRangeLabel[this.i18n].lastNDays
            this.dateRange = {
                start: start,
                end: end
            }
